...
public interface WeatherCollector {
    ...
    /*public Response createAirport(@PathParam("city") String city,
            @PathParam("country") String country,
            @PathParam("icao_code") String icao_code,
            @PathParam("longitude") String longitude,
            @PathParam("altitude") String altitude,
            @PathParam("timezone") String timezone,
            @PathParam("daylight_saving_time") String daylight_saving_time);*/
